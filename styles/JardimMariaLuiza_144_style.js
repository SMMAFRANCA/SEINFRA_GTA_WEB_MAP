var size = 0;
var placement = 'point';
function categories_JardimMariaLuiza_144(feature, value, size, resolution, labelText,
...
var style_JardimMariaLuiza_144 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_JardimMariaLuiza_144(feature, value, size, resolution, labelText,
