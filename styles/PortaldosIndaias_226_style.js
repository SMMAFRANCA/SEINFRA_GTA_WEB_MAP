...
var style_PortaldosIndaias_226 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_PortaldosIndaias_226_eval_expression(context) !== null) {
        labelText = String(exp_label_PortaldosIndaias_226_eval_expression(context));
    }
